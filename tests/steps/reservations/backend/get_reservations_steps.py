...
# GIVENs
@given('I already have at least one reservations')
...
@given('I add a new reservations for the same user')
...
@when('I do a get request for reservations using book id')
...
@when('I do a get request for reservations using user id')
...
@when('I do the get request for reservations using user_id and book id')
...
# THENs
@then('I should receive a 200 response code and a reservations has the correct attributes')
...
@then('I get the correct details of that reservations')
