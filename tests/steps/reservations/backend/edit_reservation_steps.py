...
# GIVENs
@given('I want to change the reservations dates')
...
@given('I want to change the reservations dates using not existing {param}')
...
# WHENs
@when('I do a PUT request to the reservations endpoint')
...
# THENs
@then('the response is with success and the updated reservations details are displayed')
...
@then('I get an error that the reservations that I want to edit is invalid')
